...
import { IoHeartSharp, IoSearch } from "react-icons/io5";
  ...
  return (
    <header className="bg-white fixed top-0 left-0 right-0 z-50">
      <nav className="max-w-[1400px] mx-auto px-10 md:h-[14vh] h-[12vh] flex justify-between items-center ">
        ...
        {/* Mobile menu */}
        <ul
          className={`flex flex-col gap-y-12 bg-orange-500/20 backdrop-blur-xl rounded-xl p-10 items-center gap-x-15 md:hidden absolute top-30 -left-full transform -translate-x-1/2 transition-all-duration-500 ${
            showMenu ? "left-1/2" : ""
          }`}
        >
          <li>
